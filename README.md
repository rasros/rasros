...
I build things across ML, optimization, and software infrastructure: LLM tooling, applied optimization, streaming algorithms, and efficient data structures and algorithms. Kotlin is my language of choice, with Python and Go in the mix. Head of Engineering at [Theca](https://theca.com) is my dayjob; PhD in Computer Science from Lund University.

### Repos

**Tools**
- **[lx](https://github.com/rasros/lx)** (Go) Converts files into simple Markdown-fenced blocks for easy use in LLM chats.
- **[image-to-svg](https://github.com/rasros/image-to-svg)** (Python) Vectorizes raster images (PNG/JPG) to SVG using a mix of LLMs and NSGA-II multi-objective optimization, with multiple output formats.
